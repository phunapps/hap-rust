...
/// `HAP-Characteristic-Signature-Read` companions: subscribe/unsubscribe to a
/// characteristic's event notifications.
pub(crate) const OP_SUBSCRIBE: u8 = 0x0B;
pub(crate) const OP_UNSUBSCRIBE: u8 = 0x0C;
